		...
		<Layout>
			<div className='h-full py-20 '>
				<div className='px-6 md:px-40'>
					...
					<p className='p-10 mt-10 text-lg font-semibold leading-9 text-gray-100 border'>
						Payunx Coin is an online trading service ("Service" or "Services")
						for buying and selling PXC As part of its Services Payunx Coin also
						helps resolving disputes if such should arise between buyers and
						sellers. Payunx Coin does not become a party to any trade or
					...
					<p className='p-10 mt-10 text-lg font-semibold leading-9 text-gray-100 border'>
						...
						relationship between the user and Payunx Coin Oy, a Finnish limited
						liability company.
					</p>
					<p className='p-10 mt-10 text-lg font-semibold leading-9 text-gray-100 border'>
					...
					<p className='p-10 mt-10 text-lg font-semibold leading-9 text-gray-100 border'>
						Payunx Coin is registered with and operates under the supervision of
