				...
				<div className='items-center justify-around grid-cols-2 mt-20 md:grid'>
					...
					<div className='space-y-6'>
						<p className='text-lg font-semibold'>
							Payunx Coin User Wallet-to-Wallet technology to operate with no
							central authority or banks; managing transactions and the issuing
							of Payunx Coin is carried out collectively by the network. Payunx
							Coin Coin is open-source; its design is public, nobody owns or
							controls Payunx Coin and everyone can take part. Through many of
							its unique properties, Payunx Coin allows exciting uses that could
					...
					<div className='hidden mt-10 md:mt-0 md:block'>
						<img src={logo} alt='n' className='mx-auto w-80' />
					</div>
				</div>
			</div>
			<div className='flex items-center justify-center'>
				<button className='px-8 py-4 mx-auto text-xl font-medium text-white bg-gray-900'>
					<Link to='/register' className='text-white'>
						Get Start with Payunx Coin Coin
					</Link>
				</button>
			</div>
		</div>
