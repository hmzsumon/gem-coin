	...
	return (
		<div>
			...
			<div
				id='sidebar'
				ref={sidebar}
				className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-24 lg:sidebar-expanded:!w-56 2xl:!w-64 shrink-0 bg-slate-800 border-r p-4 transition-all duration-200 ease-in-out ${
