...
import { useGetSingleUserAdminQuery } from '../../../features/admin/adminApi';
								...
								<div className='p-3 border'>
									...
									<div className='space-y-1 text-xs '>
										...
										<div className='grid grid-cols-2 list-none '>
											...
											<li>
												{Number(bonus_balance).toLocaleString('en-US', {
													style: 'currency',
													currency: 'BDT',
												})}
											</li>
										...
										<div className='grid grid-cols-2 list-none '>
											...
											<li>
												{Number(withdrawal_balance).toLocaleString('en-US', {
													style: 'currency',
													currency: 'BDT',
												})}
											</li>
